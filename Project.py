...
data = pd.read_csv("F:/My files/sece/2nd yr notes/4th sem/project/StudentPerformancePrediction-ML-main/AI-Data.csv")
ch = 0
while(ch != 10):
...
data = data.drop("ParentCollegeSatisfaction", axis=1)
...
if(choice.lower()=="y"):
    ...
    if (sur.upper() == "Y"):
       ...
       sur = 0
    sat = input("Enter Parent College Satisfaction (Good or Bad): ")
    if (sat == "Good"):
       sat = 1
    elif (sat == "Bad"):
       sat = 0
